...
public class RemoveTask extends Actions {
    ...
    /**
     * In this overridden method reside the implementation of
     * of how removing an existing task is done and how the method is executed and
     * will later be used
     * in the switch statement that runs the program
     * <p>
     * its main purpose is to remove the wanted task and confirms the completion to
     * the user
     *
